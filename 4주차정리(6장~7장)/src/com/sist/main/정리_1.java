 ...
 *               1. 초기화가 필요한 경우 
 *                  인스턴스변수 => 생성자 
 *                  static변수 => static블록을 이용 
 *           ------------------------------------
 *            메모리에 저장후에 사용 => 클래스명 객체명=new 클래스명()
 *            클래스명 => 데이터형 (지원하지 않는 데이터형이 있는 경우에
