 ...
 *       {           -------
 *           int c=30;  class => class extends
 *           int d=40;  interface => class implements
 *           public void bbb(){}
 *       }
 *                
 *       Parent p=new Parent()
 ...
 *        = 상위클래스는 공통적으로 가지고 있는 변수/메소드
 *          하위클래스는 메소드를 필요시 변경해서 사용(오버라이딩)
 *             |
...
public class 정리_3 {
	...
	public static void main(String[] args) {
		...
		// 거의 대부분 사용
		Parent pp=new Child();// a, b, aaa() => 주소값 변경
		
		Child cc=(Child)pp; // int a=(int)10.5
		// 강제 형변환
