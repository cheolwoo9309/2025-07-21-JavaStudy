 ...
 *              https://www.google.com/search?q=%EC%9E%90%EB%B0%94&oq=%EC%9E%90%EB%B0%94&gs_lcrp=EgZjaHJvbWUqBggAEEUYOzIGCAAQRRg7MgYIARBFGDwyBggCEEUYPDIGCAMQRRg80gEIMTk0NmowajeoAgCwAgA&sourceid=chrome&ie=UTF-8
 *           = 변환
 *             replace : 문자/문자열 바꿀때
 *             -------
 ...
 *             => 오라클에 데이터 추가
 *                --------------
 *                https://www.lottecinema.co.kr/NLCHS/ticketing?movieCd=22648&movieName=%EC%A2%80%EB%B9%84%EB%94%B8
 *                & => 입력 => 크롤링 오라클에 첨부
 *                => 네트워크에서 채팅
 *                   \n => \t
 *             replaceAll : 문자/문자열 바꿀때 => 정규식만
 *             => 
 *                String replaceAll(String regex,String s) => regex 정규식이란 뜻_ 패턴을 가지고 만들어 나가는 것
 *                
 *             trim : 좌우 공백문자 제거
 *             => String trim()
 *             => 로그인 / 회원가입 / 글쓰기 / 검색
 ...
 *             
 *             192.168.10.1 => [0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3} => 0~9까지 숫자의 1자리~3자리 정수 뒤 .이 들어간 형식의 값
 *             192.168.10.2
 *             192.168.10.3
 *             192.168.10.4
 *             192.168.10.5
 ...
 *             666.666.1
 *             
 *             맛있고 맛있는데 맛있는집 ... => 맛있+ => 맛있이라는 문자열로 시작하는 형식의 값
 *            
 *             
 */
public class 정리_1 {
