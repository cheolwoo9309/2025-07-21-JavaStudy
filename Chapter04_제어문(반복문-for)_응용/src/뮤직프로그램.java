...
public class 뮤직프로그램 {
	...
	public static void main(String[] args) throws Exception{
		...
		for(;;)
		{
			...
			System.out.println("4. 순위가 급상승한 노래");
			System.out.println("5. 순위가 급하락한 노래");
			...
			if(menu<1||menu>6)
			{
				...
				continue; // 메뉴 재선택하도록 처음으로 다시 돌아간다
			}
			...
			{
				System.out.println("***** 순위 급상승한 노래 *****");
			}
			else if(menu==5)
			{
				System.out.println("***** 순위 급하락한 노래 *****");
			}
