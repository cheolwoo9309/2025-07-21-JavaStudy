 ...
 *          			메모리의 이름은 kor로 설정
 *          kor=80; => 메모리 공간에 80을 저장한다
 *              -- 초기값
 *          => 불만 :
 *             => 변경 : kor=85;
 *       => 선언과 동시에 값 저장
 *          int kor=80;  => 80을 메모리 공간인 kor에 저장한다
 *					--- 1
 *				--- 2          
 *          
 *          ** 변수 => 반드시 초기값을 지정한다
 ...
 *          char c=65;
 *          	   --- int (4byte)
 *            | 2byte  (예외로 들어감_ 저장공간이 숫자가 아닌 문자라서)
 *          
 *          A => 65 , a => 97
 *          
 *          int a='a' => a = 97
...
public class 변수선언_36 {
	...
	public static void main(String[] args) {
		...
		// 상수 => 모든 문자가 대문자 (앞에 final 붙이면 상수 / final이 없으면 변수)
		final int ABC=100;
		...
		// up casting(작은 바이트를 크게 만드는경우)
        // down casting(큰 바이트를 작게 만드는경우)
