 ...
 *             => 데이터베이스(비동기) -> 동시 다발적 -> Vue.js, React
 *             |    네트워크의 접속자 저장(동기) -> 하나가 끝나고 새롭게
 *             |      |
...
public class 라이브러리_StringTokenizer_1 {
	...
	public static void main(String[] args) {
		...
		String colors="red,green,blue,black,yellow,pink,purple,magenta";
...
//		System.out.println("8' 색상:"+st.nextToken());
